...
const PRODUCTS_TO_CREATE = [
  {
    ...
    body_html:
      "<strong>A premium 65% mechanical keyboard designed for enthusiasts.</strong> Features a sleek CNC aluminum case, hot-swappable PCB, and custom gaskets for an incredibly tactile typing experience.",
    vendor: "Tactile Lab",
  ...
  },
  {
    ...
    body_html:
      "<strong>A solid 75% aluminum keyboard base with high-end brass weights.</strong> Designed with an ultra-low profile and optimized plate acoustics.",
    vendor: "Tactile Lab",
    product_type: "mechanical-keyboard",
  ...
  },
  {
    title: "TL-Carbon TKL",
    body_html:
      "<strong>A lightweight carbon-fiber TKL (tenkeyless) layout keyboard base.</strong> Incredibly crisp key press response and zero flex.",
    vendor: "Tactile Lab",
    product_type: "mechanical-keyboard",
  ...
  },
  {
    ...
    body_html:
      "<strong>Ultra-compact 60% layout mechanical keyboard.</strong> Low-latency Bluetooth and 2.4Ghz wireless connectivity, hot-swappable sockets, and custom RGB lighting matrices.",
    vendor: "Tactile Lab",
    product_type: "mechanical-keyboard",
    tags: "group-buy, new, mechanical-keyboard",
    variants: [
  ...
  },
  {
    ...
    body_html:
      "<strong>High-end professional keyboard base.</strong> Premium translucent polycarbonate case, custom brass plate, and gold-plated stabilizers.",
    vendor: "Tactile Lab",
    product_type: "mechanical-keyboard",
    tags: "group-buy, mechanical-keyboard",
    variants: [
  ...
  },
  {
    ...
    body_html:
      "<strong>Premium double-shot PBT keycap set featuring a frosted glacier ice theme.</strong> Clean legends and standard Cherry profile.",
    vendor: "Tactile Lab",
  ...
  },
  {
    ...
    body_html:
      "<strong>Pre-lubed linear switches (pack of 90).</strong> Features a smooth travel, 45g actuation force, and a satisfying deep typing sound.",
    vendor: "Tactile Lab",
    product_type: "accessories",
...
async function syncProducts() {
  ...
  if (shopList.length === 0) {
    console.error(
      "❌ No shops found in database. Please install and authorize the app first.",
    );
    process.exit(1);
  }
  ...
  if (toDelete.length > 0) {
    console.log(
      `🗑️ Deleting ${toDelete.length} snowboard/skateboard default products...`,
    );
  ...
  for (const prodData of PRODUCTS_TO_CREATE) {
    ...
    if (alreadyExists) {
      ...
      console.log(
        `⚠️ Product "${prodData.title}" already exists on store. Linking to DB...`,
      );
    } else {
      try {
        const createRes =
          await shopifyRestRequest<ShopifyProductCreateResponse>(
            shop.domain,
            accessToken,
            "products.json",
            "POST",
        ...
        console.log(
          `   Created product: ${createRes.product.title} (ID: ${shopifyId})`,
        );
      } catch (error: any) {
        console.error(
          `   ❌ Failed to create "${prodData.title}":`,
          error.message,
        );
        continue;
      }
    ...
    if (shopifyId) {
      try {
        ...
        console.log(
          `   🔗 Linked product "${prodData.title}" in DB rules table.`,
        );
      } catch (error: any) {
        console.error(
          `   ❌ Failed to link "${prodData.title}" in DB:`,
          error.message,
        );
      }
    }
